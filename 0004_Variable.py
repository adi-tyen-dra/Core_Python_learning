...
# -and allows only the relevant action wrt the var type.
...
print(type(age))
# Python's property of being dynamically-typed- if the type of variable is checked during run-time.
...
# -hence python is a strongly-typed language.
