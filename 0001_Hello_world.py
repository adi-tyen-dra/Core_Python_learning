...
# arg is the value that are passed to the func to work on, appears within the () ahead of func name in func call statement
# parameter is the var mentioned in func declaration to accept certain arg, position same as arg but in func defination
